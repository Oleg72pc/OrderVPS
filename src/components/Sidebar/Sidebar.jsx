...
function Sidebar({children}) {
  ...
  return (
    <div className='main-container'>
     <div className={isOpen ? 'icon-menu-activ' : 'icon-menu'}><img onClick={toggle} className='icon-sidebar' src={iconMenuBlack} alt='iconSidebar'></img></div>
    <div className={isOpen ? 'sidebar-activ' : 'sidebar'} >
     <div className='top_section'>
      {isOpen && <img className='logo' src={logo} alt='logo'></img>}
      <div className='bars'><img onClick={toggle} className='icon-sidebar' src={iconMenu} alt='iconSidebar'></img></div>
     </div>
